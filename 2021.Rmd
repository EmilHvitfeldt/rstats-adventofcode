...
tic()
eval(parse(text = readLines("2021/01-1.R")))
toc()
```
...
tic()
eval(parse(text = readLines("2021/01-2.R")))
toc()
```
...
tic()
eval(parse(text = readLines("2021/02-1.R")))
toc()
```
...
tic()
eval(parse(text = readLines("2021/02-2.R")))
toc()
```
...
tic()
eval(parse(text = readLines("2021/03-1.R")))
toc()
```
...
tic()
eval(parse(text = readLines("2021/03-2.R")))
toc()
```
